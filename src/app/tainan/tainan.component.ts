...
@Component({
  ...
  templateUrl: './tainan.component.html',
  styleUrl: './tainan.component.scss'
})
export class TainanComponent {
  ...
  ngOnInit(): void {
    ...
    this.httpClientService.getApi("https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-D0047-077?Authorization=CWA-F87F1543-97BC-4322-B779-633AB14E5ADA")
      .subscribe((res: any) => {
        console.log(res);
        this.resData = res;

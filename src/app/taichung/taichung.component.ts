...
@Component({
  selector: 'app-taichung',
  imports: [RouterLinkActive, RouterOutlet, CommonModule,RouterLink],
  templateUrl: './taichung.component.html',
  styleUrl: './taichung.component.scss'
})
export class TaichungComponent {
 locationName = "鹽埕區";
  WeatherElement = "溫度";
  district = 0;
  option = 0;
  ...
  ngOnInit(): void {
    ...
    this.httpClientService.getApi("https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-D0047-073?Authorization=CWA-F87F1543-97BC-4322-B779-633AB14E5ADA")
      .subscribe((res: any) => {
        console.log(res);
        this.resData = res;

...
@Component({
  selector: 'app-kaohsiung',
  imports: [RouterLinkActive, RouterOutlet, CommonModule,RouterLink],
  templateUrl: './kaohsiung.component.html',
  styleUrl: './kaohsiung.component.scss'
})
export class KaohsiungComponent {
  ...
  //改日期
  changeTime(day1: string, day2: number) {
  ...
  ngOnInit(): void {
    ...
    this.httpClientService.getApi("https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-D0047-065?Authorization=CWA-F87F1543-97BC-4322-B779-633AB14E5ADA")
      .subscribe((res: any) => {
        ...
        this.dayChange1 = new Date().toLocaleDateString();
        console.log(this.dayChange1);
      ...
      //老師的呼叫API寫法
      //getWeather(cityId:string = 'F-D0047-065'){
      //this.httpClientService.getApi("https://opendata.cwa.gov.tw/api/v1/rest/datastore/${cityId}?Authorization=CWA-F87F1543-97BC-4322-B779-633AB14E5ADA")
      //}
  }
}
